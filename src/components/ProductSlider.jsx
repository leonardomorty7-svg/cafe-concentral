...
const ProductCard = ({ id, name, tastingNotes, price, image, tag, category = 'Origen' }) => (
  ...
  >
    ...
    <div className="flex flex-col flex-grow px-2 pb-4">
      ...
      <h3 className="font-serif text-xl text-[#1A1A1A] mb-2 group-hover:text-[#D1AA49] transition-colors duration-300">
        {name}
      </h3>
      ...
      <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
        <p className="text-lg font-medium text-[#D1AA49]">
          {price}
        </p>
        <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#1A1A1A] border-b border-transparent group-hover:border-[#D1AA49] transition-all duration-300 py-1 flex items-center gap-1">
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mx-auto max-w-[720px] mb-16 px-6 text-center" data-fx="header">
          <span className="block text-[11px] tracking-[0.4em] uppercase mb-3 text-[#D1AA49] font-bold" data-fx-eyebrow>
            {title}
          </span>
          <h2 className="text-4xl md:text-6xl font-serif text-[#1A1A1A] leading-tight">
            {subtitle}{' '}
            <span className="italic text-[#D1AA49]">{subtitleItalic}</span>
          </h2>
          {description && (
