        ...
        <div className="grid md:grid-cols-12 gap-16 items-center">
          ...
          <div className="md:col-span-5 space-y-16">
            <div className="space-y-6">
              <span className="text-[11px] uppercase tracking-[0.4em] text-[#D1AA49] font-bold block reveal">
                NUESTRO ORIGEN
              </span>
              <div className="reveal delay-100">
                ...
                <p className="mt-4 md:mt-6 text-3xl md:text-4xl font-serif italic text-[#D1AA49] tracking-[0.02em] font-light">
            ...
            <div className="pt-12 reveal delay-300">
              <a href="/nosotros" className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#1A1A1A] border-b border-[#1A1A1A]/10 pb-4 hover:border-[#D1AA49] transition-all duration-500 inline-block hover:translate-x-1">
          ...
          <div className="md:col-span-7 relative">
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-8 reveal delay-200">
                ...
                <div className="bg-[#D1AA49] p-8 text-white rounded-sm">
