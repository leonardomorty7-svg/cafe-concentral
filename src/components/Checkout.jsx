      ...
      <div className="order-2 lg:order-1 flex flex-col gap-14">
        ...
        <section>
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-[#1A1A1A] leading-tight mb-10">
            ¿A dónde <span className="italic text-[#D1AA49]">enviamos</span> tu café?
          </h2>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              className="w-full bg-white border border-[#1A1A1A]/12 rounded-sm px-4 py-3 text-[#1A1A1A] placeholder:text-[#B5B0A6] focus:outline-none focus:border-[#D1AA49] transition-colors font-light"
            />
          </div>
        </section>
        ...
        <section>
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-[#1A1A1A] leading-tight mb-4">
            Elige cómo <span className="italic text-[#D1AA49]">prefieres</span> pagar.
          </h2>
              ...
              return (
                <label
                  ...
                  className={`flex items-start gap-4 p-5 rounded-sm border cursor-pointer transition-all duration-300 ${
                    active
                      ? 'border-[#D1AA49] bg-[#D1AA49]/8 shadow-sm'
                      : 'border-[#1A1A1A]/10 bg-white hover:border-[#D1AA49]/40'
                  }`}
                >
                  <input
                    type="radio"
                  ...
                  <span
                    className={`mt-0.5 w-5 h-5 rounded-full border-2 shrink-0 flex items-center justify-center transition-colors ${
                      active ? 'border-[#D1AA49]' : 'border-[#1A1A1A]/25'
                    }`}
                  >
                    {active && <span className="w-2.5 h-2.5 rounded-full bg-[#D1AA49]" />}
                  </span>
                  <span>
            ...
            <div className="flex items-start gap-4 p-5 rounded-sm border border-dashed border-[#1A1A1A]/12 bg-transparent opacity-70">
              ...
              <span>
                <span className="block font-serif text-lg text-[#1A1A1A]/60 leading-tight">
                  ...
                  <span className="ml-2 text-[9px] uppercase tracking-[0.2em] bg-[#D1AA49]/15 text-[#D1AA49] font-bold px-2 py-0.5 rounded-full align-middle">
                    Muy pronto
                  </span>
                </span>
...
const Field = ({ label, value, onChange, type = 'text', required = false, invalid = false, hint }) => (
  <div data-invalid={invalid ? 'true' : 'false'}>
    <label className="block text-[11px] uppercase tracking-[0.2em] font-bold text-[#1A1A1A] mb-3">
      {label} {required && <span className="text-[#D1AA49]">*</span>}
    </label>
    <input
      type={type}
      value={value}
      ...
      className={`w-full bg-white border rounded-sm px-4 py-3 text-[#1A1A1A] placeholder:text-[#B5B0A6] focus:outline-none transition-colors font-light ${
        invalid ? 'border-[#B4462F]' : 'border-[#1A1A1A]/12 focus:border-[#D1AA49]'
      }`}
    />
